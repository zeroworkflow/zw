...
# ZeroWorkflow GitHub Release Installer
...
print_header() {
    echo -e "${PURPLE}"
    echo "╔══════════════════════════════════════╗"
    echo "║     ZeroWorkflow GitHub Installer    ║"
...
get_latest_version() {
    local repo="derxanax/ZeroWorkflow"
...
EOF
        ...
        print_status "Or set AI_TOKEN as environment variable"
    else
...
main() {
    ...
    echo
    print_status "📚 Documentation: https://github.com/derxanax/ZeroWorkflow"
    print_status "🐛 Issues: https://github.com/derxanax/ZeroWorkflow/issues"
}
...
case "${1:-}" in
    --help|-h)
        ...
        ;;
    --version|-v)
        echo "ZeroWorkflow GitHub Installer v1.0.0"
        exit 0
        ;;
    *)
        main "$@"
